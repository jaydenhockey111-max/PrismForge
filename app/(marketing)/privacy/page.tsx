...
export default function PrivacyPage() {
  return <main className="mx-auto max-w-3xl px-5 py-16 lg:py-24">
    ...
    <p className="mt-6 text-lg leading-8 text-ink/65">{APP_NAME} uses the information you provide to generate founder reports, personalize project guidance, and organize the evidence and decisions you record. This policy explains the MVP&apos;s current data practices.</p>
    <div className="mt-10 grid gap-9 leading-7 text-ink/70">
      ...
      <section><h2 className="font-display text-2xl font-semibold text-ink">How we use it</h2><p className="mt-3">We use profile information to calculate founder-fit scores, display project recommendations, organize evidence and decisions, secure your account, administer subscriptions, send requested alerts, prevent abuse, and improve reliability. We do not sell personal information.</p></section>
      <section><h2 className="font-display text-2xl font-semibold text-ink">Service providers</h2><p className="mt-3">The MVP uses Supabase for authentication and database hosting, Vercel for application hosting, Stripe for subscription billing when enabled, and Resend for transactional email.</p></section>
