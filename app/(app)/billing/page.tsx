...
export default async function BillingPage({ searchParams }: { searchParams: Promise<{ success?: string; canceled?: string; error?: string }> }) {
  ...
  return <div className="max-w-5xl">
    ...
    <section className="rounded-[2rem] border border-violet/15 bg-white/80 p-7 shadow-card">
      <p className="mt-1 text-sm font-bold uppercase tracking-[.16em] text-violet">Membership</p><h1 className="mt-2 font-display text-4xl font-semibold tracking-tight">Plan & billing</h1><p className="mt-3 text-ink/60">Payments are intentionally paused during private beta. Use this page to understand your current access and the future plan direction.</p>
    </section>
