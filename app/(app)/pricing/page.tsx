...
const tiers = [
  ...
  },
  {
    ...
    features: ["More saved projects", "Progress tracking across projects", "AI strategy with safety caps", "Proof Board history", "Next Move and outreach help", "Exports and saved outputs"],
