  ...
  return (
    <div className={compact ? "grid gap-5" : "grid gap-7"}>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        ...
        <HandbookCard icon={<Lightbulb className="size-5" />} title="Focus the uncertainty" text="Start with the Biggest Question and one Next Move. They keep the project centered on what must be learned before more building." />
        ...
        <HandbookCard icon={<CheckCircle2 className="size-5" />} title="Review what changed" text="Use Review for evidence, decisions, meaningful history, and patterns from earlier projects. Current evidence still controls your Next Move." />
        <HandbookCard icon={<Compass className="size-5" />} title="Review launch blockers" text="Use factual checks and recorded evidence to see whether this idea is ready for friends, testers, or more validation." />
      </section>
