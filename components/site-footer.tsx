...
export function SiteFooter() {
  return (
    <footer className="border-t border-ink/10 bg-white/80 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-5 py-9 sm:flex-row sm:items-center sm:justify-between lg:px-8">
        <Logo />
        <nav className="flex flex-wrap gap-5 text-sm font-semibold text-ink/60" aria-label="Legal">
